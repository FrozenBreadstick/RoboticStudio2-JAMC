...
YOLO_IMG_SIZE  = 1088    ## Full YOLO resolution
...
class AprilTagPianoDetector(Node):
    ...
    def __init__(self):
        ...
        self.yolo_model = YOLO('/home/vito/Downloads/best (1).pt')
        ...
        self._fps_count = 0
        self._fps       = 0.0
        cv2.namedWindow("Piano Keys", cv2.WINDOW_NORMAL)
        cv2.resizeWindow("Piano Keys", 960, 540)
        self.get_logger().info(
